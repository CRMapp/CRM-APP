...
- (void)setUp
{
    ...
    perspective = -1.0f/400.0f;
    decelerationRate = 20.0f; //0.95f; for fast scrolling
    scrollEnabled = YES;
    bounces = YES;
    scrollOffset = 50.0f;
    offsetMultiplier = 51.0f;
...
{	
    ...
    switch (type)
    {
        ...
        {
            CGFloat tilt = [self valueForTransformOption:iCarouselTranformOptionTilt withDefault:0.5f];
            CGFloat spacing = [self valueForTransformOption:iCarouselTranformOptionSpacing withDefault:0.23f]; // should be ~ 1/scrollSpeed;
            ...
            CGFloat z = fabsf(clampedOffset) * -itemWidth * 0.1f;
            ...
            else
            {
                ...
                return CATransform3DRotate(transform, -clampedOffset * M_PI_2 * tilt, 0.0f, 0.1f, 0.0f);
            }
        }
		case iCarouselTypeTimeMachine:
        case iCarouselTypeInvertedTimeMachine:
		{
			...
			CGFloat spacing = [self valueForTransformOption:iCarouselTranformOptionSpacing withDefault:3.0f];
